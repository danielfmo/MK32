...
#define COMP(x, y) ((memcmp(x, y, sizeof(y) - 1) == 0) && (x[sizeof(y) - 1] == '\0' || x[sizeof(y) - 1] == '\r' || x[sizeof(y) - 1] == '\n' || x[sizeof(y) - 1] == ' '))
...
#include "keylayouts.h"
    {CIRCUMFLEX_BITS, ACUTE_ACCENT_BITS, GRAVE_ACCENT_BITS, TILDE_BITS, DIAERESIS_BITS}, {DEADKEY_CIRCUMFLEX, DEADKEY_ACUTE_ACCENT, DEADKEY_GRAVE_ACCENT, DEADKEY_TILDE, DEADKEY_DIAERESIS}};
///@cond DONTINCLUDETHIS
const uint16_t deadkey_DE[2][3] = {
#include "undefkeylayouts.h"
#define LAYOUT_GERMAN
#include "keylayouts.h"
    {CIRCUMFLEX_BITS, ACUTE_ACCENT_BITS, GRAVE_ACCENT_BITS}, {DEADKEY_CIRCUMFLEX, DEADKEY_ACUTE_ACCENT, DEADKEY_GRAVE_ACCENT}};
...
#include "keylayouts.h"
    {CIRCUMFLEX_BITS, ACUTE_ACCENT_BITS, GRAVE_ACCENT_BITS, DIAERESIS_BITS, CEDILLA_BITS}, {DEADKEY_CIRCUMFLEX, DEADKEY_ACUTE_ACCENT, DEADKEY_GRAVE_ACCENT, DEADKEY_DIAERESIS, DEADKEY_CEDILLA}};
const uint16_t deadkey_CAINT[2][7] = {
#include "undefkeylayouts.h"
#define LAYOUT_CANADIAN_MULTILINGUAL
#include "keylayouts.h"
    {CIRCUMFLEX_BITS, ACUTE_ACCENT_BITS, GRAVE_ACCENT_BITS, DIAERESIS_BITS, CEDILLA_BITS, TILDE_BITS, RING_ABOVE_BITS}, {DEADKEY_CIRCUMFLEX, DEADKEY_ACUTE_ACCENT, DEADKEY_GRAVE_ACCENT, DEADKEY_DIAERESIS, DEADKEY_CEDILLA, DEADKEY_TILDE, DEADKEY_RING_ABOVE}};
...
#include "keylayouts.h"
    {CIRCUMFLEX_BITS, GRAVE_ACCENT_BITS, TILDE_BITS, DIAERESIS_BITS}, {DEADKEY_CIRCUMFLEX, DEADKEY_GRAVE_ACCENT, DEADKEY_TILDE, DEADKEY_DIAERESIS}};
...
#include "keylayouts.h"
    {CIRCUMFLEX_BITS, ACUTE_ACCENT_BITS, GRAVE_ACCENT_BITS, DIAERESIS_BITS}, {DEADKEY_CIRCUMFLEX, DEADKEY_ACUTE_ACCENT, DEADKEY_GRAVE_ACCENT, DEADKEY_DIAERESIS}};
const uint16_t deadkey_IR[2][2] = {
#include "undefkeylayouts.h"
#define LAYOUT_IRISH
#include "keylayouts.h"
    {ACUTE_ACCENT_BITS, GRAVE_ACCENT_BITS}, {DEADKEY_ACUTE_ACCENT, DEADKEY_GRAVE_ACCENT}};
const uint16_t deadkey_IC[2][5] = {
#include "undefkeylayouts.h"
#define LAYOUT_ICELANDIC
#include "keylayouts.h"
    {CIRCUMFLEX_BITS, ACUTE_ACCENT_BITS, GRAVE_ACCENT_BITS, RING_ABOVE_BITS, DIAERESIS_BITS}, {DEADKEY_CIRCUMFLEX, DEADKEY_ACUTE_ACCENT, DEADKEY_GRAVE_ACCENT, DEADKEY_RING_ABOVE, DEADKEY_DIAERESIS}};
...
#define LAYOUT_CZECH
#include "keylayouts.h"
    {/*CIRCUMFLEX_BITS,*/ DOUBLE_ACUTE_BITS, CEDILLA_BITS, DEGREE_SIGN_BITS, CARON_BITS, ACUTE_ACCENT_BITS, BREVE_BITS, /*GRAVE_ACCENT_BITS,*/
     DOT_ABOVE_BITS, /*DIAERESIS_BITS, */ OGONEK_BITS},
    {                                                                                                                /*DEADKEY_CIRCUMFLEX,*/
     DEADKEY_DOUBLE_ACUTE, DEADKEY_CEDILLA, DEADKEY_DEGREE_SIGN, DEADKEY_CARON, DEADKEY_ACUTE_ACCENT, DEADKEY_BREVE, /*DEADKEY_GRAVE_ACCENT,*/
     DEADKEY_DOT_ABOVE, /*DEADKEY_DIAERESIS, */ DEADKEY_OGONEK}};
 ...
 * */
const uint16_t *keycodes_deadkey_bits[] = {deadkey_USINT[0], deadkey_DE[0], deadkey_DEMAC[0], deadkey_CAFR[0], deadkey_CAINT[0], deadkey_UK[0],   deadkey_FI[0],    deadkey_FR[0], deadkey_DK[0], deadkey_NW[0], deadkey_SW[0], deadkey_ES[0],
                                           deadkey_PT[0],    deadkey_IT[0], deadkey_PTBR[0],  deadkey_FRBE[0], deadkey_DESW[0],  deadkey_FRSW[0], deadkey_ESLAT[0], deadkey_IR[0], deadkey_IC[0], deadkey_TK[0], deadkey_CZ[0], deadkey_SR[0]};
 ...
 * LAYOUT_US_ENGLISH (no deadkeys at all)
 * */
const uint16_t *keycodes_deadkey[] = {deadkey_USINT[1], deadkey_DE[1], deadkey_DEMAC[1], deadkey_CAFR[1], deadkey_CAINT[1], deadkey_UK[1],   deadkey_FI[1],    deadkey_FR[1], deadkey_DK[1], deadkey_NW[1], deadkey_SW[1], deadkey_ES[1],
                                      deadkey_PT[1],    deadkey_IT[1], deadkey_PTBR[1],  deadkey_FRBE[1], deadkey_DESW[1],  deadkey_FRSW[1], deadkey_ESLAT[1], deadkey_IR[1], deadkey_IC[1], deadkey_TK[1], deadkey_CZ[1], deadkey_SR[1]};
...
#define LAYOUT_US_ENGLISH
#include "keylayouts.h"
    {ASCII_20, ASCII_21, ASCII_22, ASCII_23, ASCII_24, ASCII_25, ASCII_26, ASCII_27, ASCII_28, ASCII_29, ASCII_2A, ASCII_2B, ASCII_2C, ASCII_2D, ASCII_2E, ASCII_2F, ASCII_30, ASCII_31, ASCII_32, ASCII_33, ASCII_34, ASCII_35, ASCII_36, ASCII_37,
     ASCII_38, ASCII_39, ASCII_3A, ASCII_3B, ASCII_3C, ASCII_3D, ASCII_3E, ASCII_3F, ASCII_40, ASCII_41, ASCII_42, ASCII_43, ASCII_44, ASCII_45, ASCII_46, ASCII_47, ASCII_48, ASCII_49, ASCII_4A, ASCII_4B, ASCII_4C, ASCII_4D, ASCII_4E, ASCII_4F,
     ASCII_50, ASCII_51, ASCII_52, ASCII_53, ASCII_54, ASCII_55, ASCII_56, ASCII_57, ASCII_58, ASCII_59, ASCII_5A, ASCII_5B, ASCII_5C, ASCII_5D, ASCII_5E, ASCII_5F, ASCII_60, ASCII_61, ASCII_62, ASCII_63, ASCII_64, ASCII_65, ASCII_66, ASCII_67,
     ASCII_68, ASCII_69, ASCII_6A, ASCII_6B, ASCII_6C, ASCII_6D, ASCII_6E, ASCII_6F, ASCII_70, ASCII_71, ASCII_72, ASCII_73, ASCII_74, ASCII_75, ASCII_76, ASCII_77, ASCII_78, ASCII_79, ASCII_7A, ASCII_7B, ASCII_7C, ASCII_7D, ASCII_7E, ASCII_7F},
#include "undefkeylayouts.h"
#define LAYOUT_US_INTERNATIONAL
#include "keylayouts.h"
    {ASCII_20, ASCII_21, ASCII_22, ASCII_23, ASCII_24, ASCII_25, ASCII_26, ASCII_27, ASCII_28, ASCII_29, ASCII_2A, ASCII_2B, ASCII_2C, ASCII_2D, ASCII_2E, ASCII_2F, ASCII_30, ASCII_31, ASCII_32, ASCII_33, ASCII_34, ASCII_35, ASCII_36, ASCII_37,
...
#define LAYOUT_US_INTERNATIONAL
#include "keylayouts.h"
    {ISO_8859_1_A0, ISO_8859_1_A1, ISO_8859_1_A2, ISO_8859_1_A3, ISO_8859_1_A4, ISO_8859_1_A5, ISO_8859_1_A6, ISO_8859_1_A7, ISO_8859_1_A8, ISO_8859_1_A9, ISO_8859_1_AA, ISO_8859_1_AB, ISO_8859_1_AC, ISO_8859_1_AD, ISO_8859_1_AE, ISO_8859_1_AF,
     ISO_8859_1_B0, ISO_8859_1_B1, ISO_8859_1_B2, ISO_8859_1_B3, ISO_8859_1_B4, ISO_8859_1_B5, ISO_8859_1_B6, ISO_8859_1_B7, ISO_8859_1_B8, ISO_8859_1_B9, ISO_8859_1_BA, ISO_8859_1_BB, ISO_8859_1_BC, ISO_8859_1_BD, ISO_8859_1_BE, ISO_8859_1_BF,
     ISO_8859_1_C0, ISO_8859_1_C1, ISO_8859_1_C2, ISO_8859_1_C3, ISO_8859_1_C4, ISO_8859_1_C5, ISO_8859_1_C6, ISO_8859_1_C7, ISO_8859_1_C8, ISO_8859_1_C9, ISO_8859_1_CA, ISO_8859_1_CB, ISO_8859_1_CC, ISO_8859_1_CD, ISO_8859_1_CE, ISO_8859_1_CF,
     ISO_8859_1_D0, ISO_8859_1_D1, ISO_8859_1_D2, ISO_8859_1_D3, ISO_8859_1_D4, ISO_8859_1_D5, ISO_8859_1_D6, ISO_8859_1_D7, ISO_8859_1_D8, ISO_8859_1_D9, ISO_8859_1_DA, ISO_8859_1_DB, ISO_8859_1_DC, ISO_8859_1_DD, ISO_8859_1_DE, ISO_8859_1_DF,
     ISO_8859_1_E0, ISO_8859_1_E1, ISO_8859_1_E2, ISO_8859_1_E3, ISO_8859_1_E4, ISO_8859_1_E5, ISO_8859_1_E6, ISO_8859_1_E7, ISO_8859_1_E8, ISO_8859_1_E9, ISO_8859_1_EA, ISO_8859_1_EB, ISO_8859_1_EC, ISO_8859_1_ED, ISO_8859_1_EE, ISO_8859_1_EF,
     ISO_8859_1_F0, ISO_8859_1_F1, ISO_8859_1_F2, ISO_8859_1_F3, ISO_8859_1_F4, ISO_8859_1_F5, ISO_8859_1_F6, ISO_8859_1_F7, ISO_8859_1_F8, ISO_8859_1_F9, ISO_8859_1_FA, ISO_8859_1_FB, ISO_8859_1_FC, ISO_8859_1_FD, ISO_8859_1_FE, ISO_8859_1_FF},
///@cond DONTINCLUDETHIS
#include "undefkeylayouts.h"
#define LAYOUT_GERMAN
#include "keylayouts.h"
...
uint8_t parse_for_keycode(uint8_t inputdata, uint8_t locale, uint8_t *keycode_modifier, uint8_t *deadkey_first_keycode) {
    ...
    if (inputdata < 0x80) {
        ...
        *keycode_modifier = keycode_to_modifier(keycode, locale);
        if (deadkey)
            *deadkey_first_keycode = keycode_to_key(deadkey);
        else
            *deadkey_first_keycode = 0;
...
uint8_t add_keycode(uint8_t keycode, uint8_t *keycode_arr) {
    ...
    if (keycode_arr[0] != keycode && keycode_arr[1] != keycode && keycode_arr[2] != keycode && keycode_arr[3] != keycode && keycode_arr[4] != keycode && keycode_arr[5] != keycode) {
        for (i = 0; i < 6; i++) {
...
uint16_t parseKeycodeToIdentifier(uint16_t keycode, char *buffer, uint8_t buf_len) {
    switch (keycode) {
        ...
        case KEY_MEDIA_POWER:
            SAVE("KEY_MEDIA_POWER");
        case KEY_MEDIA_RESET:
            SAVE("KEY_MEDIA_RESET");
        case KEY_MEDIA_SLEEP:
            SAVE("KEY_MEDIA_SLEEP");
        case KEY_MEDIA_MENU:
            SAVE("KEY_MEDIA_MENU");
        case KEY_MEDIA_SELECTION:
            SAVE("KEY_MEDIA_SELECTION");
        case KEY_MEDIA_ASSIGN_SEL:
            SAVE("KEY_MEDIA_ASSIGN_SEL");
        case KEY_MEDIA_MODE_STEP:
            SAVE("KEY_MEDIA_MODE_STEP");
        case KEY_MEDIA_RECALL_LAST:
            SAVE("KEY_MEDIA_RECALL_LAST");
        case KEY_MEDIA_QUIT:
            SAVE("KEY_MEDIA_QUIT");
        case KEY_MEDIA_HELP:
            SAVE("KEY_MEDIA_HELP");
        case KEY_MEDIA_CHANNEL_UP:
            SAVE("KEY_MEDIA_CHANNEL_UP");
        case KEY_MEDIA_CHANNEL_DOWN:
            SAVE("KEY_MEDIA_CHANNEL_DOWN");
        case KEY_MEDIA_SELECT_DISC:
            SAVE("KEY_MEDIA_SELECT_DISC");
        case KEY_MEDIA_ENTER_DISC:
            SAVE("KEY_MEDIA_ENTER_DISC");
        case KEY_MEDIA_REPEAT:
            SAVE("KEY_MEDIA_REPEAT");
        case KEY_MEDIA_VOLUME:
            SAVE("KEY_MEDIA_VOLUME");
        case KEY_MEDIA_BALANCE:
            SAVE("KEY_MEDIA_BALANCE");
        case KEY_MEDIA_BASS:
            SAVE("KEY_MEDIA_BASS");
        ...
        case KEY_MEDIA_PAUSE:
            SAVE("KEY_MEDIA_PAUSE");
        case KEY_MEDIA_RECORD:
            SAVE("KEY_MEDIA_RECORD");
        case KEY_MEDIA_FAST_FORWARD:
            SAVE("KEY_MEDIA_FAST_FORWARD");
        case KEY_MEDIA_REWIND:
            SAVE("KEY_MEDIA_REWIND");
        case KEY_MEDIA_NEXT_TRACK:
            SAVE("KEY_MEDIA_NEXT_TRACK");
        case KEY_MEDIA_PREV_TRACK:
            SAVE("KEY_MEDIA_PREV_TRACK");
        case KEY_MEDIA_STOP:
            SAVE("KEY_MEDIA_STOP");
        case KEY_MEDIA_EJECT:
            SAVE("KEY_MEDIA_EJECT");
        case KEY_MEDIA_RANDOM_PLAY:
            SAVE("KEY_MEDIA_RANDOM_PLAY");
        case KEY_MEDIA_STOP_EJECT:
            SAVE("KEY_MEDIA_STOP_EJECT");
        case KEY_MEDIA_PLAY_PAUSE:
            SAVE("KEY_MEDIA_PLAY_PAUSE");
        case KEY_MEDIA_PLAY_SKIP:
            SAVE("KEY_MEDIA_PLAY_SKIP");
        case KEY_MEDIA_MUTE:
            SAVE("KEY_MEDIA_MUTE");
        case KEY_MEDIA_VOLUME_INC:
            SAVE("KEY_MEDIA_VOLUME_INC");
        case KEY_MEDIA_VOLUME_DEC:
            SAVE("KEY_MEDIA_VOLUME_DEC");

        case KEY_SYSTEM_POWER_DOWN:
            SAVE("KEY_SYSTEM_POWER_DOWN");
        case KEY_SYSTEM_SLEEP:
            SAVE("KEY_SYSTEM_SLEEP");
        case KEY_SYSTEM_WAKE_UP:
            SAVE("KEY_SYSTEM_WAKE_UP");
        case KEY_MINUS:
            SAVE("KEY_MINUS");
        case KEY_EQUAL:
            SAVE("KEY_EQUAL");
