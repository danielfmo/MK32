...
// Example from https://github.com/SOGOR/MK32/blob/master/main/keymap.c
// NOTE: For this keymap due to wiring constraints the the two last rows on the left are wired unconventionally
    ...
    //         {KC_ESC,  KC_GRV,   KC_F2,      KC_F3,  KC_F4,  KC_F5,  KC_F7,  KC_F8,  KC_F9,  FC_F10,     KC_F11,     KC_F12,     KC_VOLD,    KC_VOLU,    KC_PSCR,    KC_LSCR,    KC_BRK }
    // };
