 ...
 */
const gpio_num_t MATRIX_ROWS_PINS[] = {GPIO_NUM_33, GPIO_NUM_36, GPIO_NUM_37, GPIO_NUM_38, GPIO_NUM_39, GPIO_NUM_35};

const gpio_num_t MATRIX_COLS_PINS[] = {GPIO_NUM_0, GPIO_NUM_2, GPIO_NUM_17, GPIO_NUM_4, GPIO_NUM_16, GPIO_NUM_15, GPIO_NUM_19, GPIO_NUM_23, GPIO_NUM_22, GPIO_NUM_5, GPIO_NUM_18, GPIO_NUM_32, GPIO_NUM_26, GPIO_NUM_14, GPIO_NUM_21, GPIO_NUM_27, GPIO_NUM_25};
...
void rtc_matrix_setup(void) {
    ...
    for (uint8_t col = 0; col < MATRIX_COLS; col++) {
        if (rtc_gpio_is_valid_gpio(MATRIX_COLS_PINS[col]) == 1) {
            rtc_gpio_init((MATRIX_COLS_PINS[col]));
            rtc_gpio_set_direction(MATRIX_COLS_PINS[col], RTC_GPIO_MODE_INPUT_ONLY);
